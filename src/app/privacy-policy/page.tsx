    ...
    <main className="bg-white font-[Poppins] min-w-[320px]">
      ...
      <div className="md:w-[85%] mx-auto max-md:px-10 py-10">
        ...
        <div className="mt-10">
          ...
          and Applications (as defined in the <a href="/terms-of-service" style={{ color: "blue", textDecoration: "underline" }}>Terms and Conditions of Service</a> or
          Agreement).
        </div>
        ...
        <div className="mt-10">
          In order to provide our Services, we collect information about you that alone or in combination with other information, can be used to identify you as an individual
          (“personal information”). What personal information we collect and process when you use our Services depends on how and why you interact with us

        </div>
        <div className="mt-5">
          <span className="underline ">Personal Information You Provide.</span> When you register for an account or subscribe to any of our Services, we collect a variety of information about you, including your contact information such as your name, email address, contact number, mailing address, date of birth, dating preferences, etc. When you sign up for our Services, you may provide us with answers to our proprietary questionnaire (our Compatibility Quiz), which we use to build a personality profile for you and to match you with other compatible singles. You may also choose to provide us with your photo(s), which may contain personal information. By providing us with photo(s), you agree that we may make them available to your potential partners and users of KJLEMON’s Services. We may also collect your name, contact information (such as your email), and a copy of your correspondence with us if you contact us. If you correspond with other KJLEMON members through the KJLEMON platform, we will collect and store this information. To process purchases, we may require your name, address, phone number, email address, and payment information, including but not necessarily limited to credit or debit card information and associated account information. If you would like us to delete such payment information from our systems, you may contact us as described under the “Contacting Us” section below.
        </div>

        <div className="mt-5">
          <span className="underline">Sensitive Personal Information.</span> During the registration process and while updating your profile, you may provide us with personal information that is considered “sensitive” in your jurisdiction, including but not limited to, religious beliefs, ethnicity, and political views. This information is only used by us to provide the services to you. You may change or update your information by accessing your profile at any time or selecting the “prefer not to specify” option in response to any questions requesting such information.
        </div>
        <div className="mt-5">
        ...
        <div>
          <a style={{ color: "black", textDecoration: "underline" }}>What kind of cookies does KJLEMON use?</a>

        </div>

        <strong>Strictly necessary cookies</strong>
        <div>
          <p>We use certain cookies to make sure that our Websites and our Services are easy, secure, and safe to use. Without these cookies, the Services that you have asked for (such as secure Websites and Services), would not be possible. This category of cookies includes: </p>
        ...
        <div>
          <strong> 2. How and Why We Use Your Personal Information</strong>
        ...
        <div>
          ...
          <p>•	Establish and manage user accounts, such as your “My Profile”;</p>
          <p>•	Display the public fields of your profile to your potential partners, including recent login date, user name, photos, videos, and other profile content;</p>
          <p>•	Provide customer support, troubleshoot issues, manage our Services, and respond to requests, questions, and comments;</p>
          <p>•	Process transactions;</p>
          <p>•	Communicate with you about our Services, including order confirmation, refund, and renewal processing, notifying of potential partners for our Service, Service announcements, and administrative messages;</p>
          <p>•	Communicate with you regarding promotions, including newsletters, new product offerings, special discounts, and event notifications. Our communications may include advertisements and other third-party promotional materials, campaigns, and tools.;</p>
          <p>•	Conduct market and consumer research and trend analyses;</p>
          <p>•	Enable posting on our blogs, forums, and other public communications;</p>
          <p>•	Perform   accounting,   auditing,   billing,   reconciliation,   and   collection   activities including collecting on outstanding and past due account balances;</p>
          <p>•	Prevent,  detect,  identify,  investigate,  and  respond  to  potential  or actual  claims, liabilities, prohibited behavior, and criminal activity;</p>
          <p>•	Comply with and enforce legal requirements, agreements, and policies;</p>
          <p>•	Achieve purposes for which we provide specific notice at the time of collection; and</p>
          <p>•	For any other purpose with your consent.</p>
          One of the methods we use to communicate with you in connection with KJLEMON’s Services may be by telephone or text message (including any wireless number you may provide to us). For example, you may sign up for a text messaging service (“SMS Verification”) which enables KJLEMON to verify your phone number via a confirmed text message and display such verification in your public account (as a security measure for your potential partners’ benefit). If you would rather not receive telephone calls or text messages from us, you may change or delete your number from your account preferences page(s) or ask to be removed from our contact list if you receive a call or text message from us. If you want to opt out of the SMS Verification service, please <a style={{ textDecoration: "underline", color: "blue" }}>send us an e-mail</a> at any time. Please note that we or one of our service providers may contact you by telephone in connection with an outstanding and past-due balance on your account. Opting out of receiving telephone calls will not prevent you from receiving calls related to an outstanding balance.
        ...
        <div>
          <strong>3. Mobile Push Notifications</strong>
        ...
        <div>
          <a style={{ textDecoration: "underline" }}>In general.</a> We may disclose the personal information we collect:
          <p>•	With current and future organizations that are part of our network of organizations for the purposes described in this Privacy Policy, including with your consent.</p>
          <p> •	With affiliated and unaffiliated service providers who help us perform and deliver our Services, subject to confidentiality agreements, including customer care agents; technology assistants; service fulfillment; form processing; website management and hosting; information technology and security; email and newsletter delivery; marketing vendors; auditing; collection agencies; and credit card processing.</p>
          <p>•	With third parties  such  as  advertising  partners,  including  direct  partners  and advertising networks, and corporate sponsors;</p>
          <p>•	With the appropriate authorities if we believe disclosure is necessary and appropriate to prevent physical, financial, or other harm, injury, or loss, including to protect against fraud or credit risk.</p>
          <p>•	With legal, governmental, or judicial authorities as instructed or required by those authorities and applicable laws, or to a legal activity, such as in response to a subpoena or investigation of suspected illicit or illegal activities, or where we believe in good faith that users may be engaged in illicit or illegal activities, or where we are bound by contract or law to enable a network partner to comply with applicable laws;</p>
          <p>•	With necessary third parties in connection with, or during negotiations for, an acquisition, merger, asset sale, or other similar business transfer that involves all or substantially all of our assets or functions where personal information is transferred or shared as part of the business assets.</p>
          <p>•	With your consent or at your direction, such as when you choose to share information or publicly post content and reviews (for example, social media posts); and</p>
          <p>•	With persons of your choosing and at your discretion, should the Services you are subscribed to allow that functionality.</p>
