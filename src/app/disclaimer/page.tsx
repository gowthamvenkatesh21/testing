    ...
    <main className="bg-white font-[Poppins] min-w-[320px]">
      ...
      <div className="md:w-[85%] mx-auto max-md:px-10 py-10">
        ...
        <div className="space-y-4 text-sm font-bold">
          ...
          <p>
            The free account, a user will not pay but can communicate with other users through unlimited chat , and for the basic and premium account, users will be required to subscribe in order to enjoy premium features , receiving gifts from other users, can see when another user read my messages. Video call will be included in premium subscriptions
          </p>
          {/* <p>
